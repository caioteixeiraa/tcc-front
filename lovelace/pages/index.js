      ...
      {isMobile ? 
        <>
          ...
          <Stack my='48px' mx="16px" spacing='24px'>
            <Stack spacing='8px'>
              <Heading as="h1" size="3xl" textAlign="center" fontFamily='Bebas Neue, sans-serif'>Bem-vinda(o) ao <u>Mentorada</u>!</Heading>
          ...
          <Box bg='#2B7DE9' w='100vw' py='16px'>
              <Heading as="h2" size="2xl" m="24px" color='white' fontFamily='Bebas Neue, sans-serif' textAlign='center'>Como funciona:</Heading>
              <Box d='flex' flexDir='column' justifyContent='center' alignItems='center' textAlign='center'>
                <Box maxW='300px' bg='white' border='2px solid #000000' p='24px' borderRadius='8px'>
                  <Text fontSize='6xl' fontFamily='Bebas Neue, sans-serif'>1</Text>
                  <Text fontSize='2xl' as='u' fontFamily='Bebas Neue, sans-serif'>Cadastre-se</Text>
                ...
                <Box maxW='300px' bg='white' border='2px solid #000000' p='24px' borderRadius='8px' mt='16px'>
                  <Text fontSize='6xl' fontFamily='Bebas Neue, sans-serif'>2</Text>
                  <Text fontSize='2xl' as='u' fontFamily='Bebas Neue, sans-serif'>Crie um perfil</Text>
                ...
                <Box maxW='300px' bg='white' border='2px solid #000000' p='24px' borderRadius='8px' mt='16px'>
                  <Text fontSize='6xl' fontFamily='Bebas Neue, sans-serif'>3</Text>
                  <Text fontSize='2xl' as='u' fontFamily='Bebas Neue, sans-serif'>Pronto!</Text>
        ...
        <Box>
          <Box bg='#2B7DE9' d='flex' flexDir='column' justifyContent='center' alignItems='center' p="40px">
            ...
            <Heading as="h1" size="4xl" mt="24px" color='white' fontFamily='Bebas Neue, sans-serif'>Bem-vinda(o) ao <u>Mentorada</u>!</Heading>
          </Box>
          <Box d='flex' flexDir='column' alignItems='center' textAlign='center'>
            ...
            <Box bg='#2B7DE9' w='100vw'>
              <Heading as="h2" size="2xl" m="24px" color='white' fontFamily='Bebas Neue, sans-serif'>Como funciona:</Heading>
